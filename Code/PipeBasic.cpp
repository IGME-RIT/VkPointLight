...
// This is exactly the same as PipeSky,
// except for the shaders. With this setup,
// anything related to the pipeline can be changed

PipeBasic::PipeBasic(VkDevice dev, VkDescriptorSetLayout desc_layout, VkRenderPass render_pass)
{
	device = dev;
	...
	VkPipelineVertexInputStateCreateInfo vi = VertexStructure::GetState();
